...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		case LORRY:
			...
			AddWheels(lorry);
			System.out.println("Camió amb matrícula "+lorry.getPlate()+" ha estat creat correctament.\n");
			break;
		default:
	...
	public static VehicleType ChooseTypeVehicle() throws Exception {
		int input=Integer.parseInt(JOptionPane.showInputDialog("Escolliu tipus de vehicle: 1=cotxe, 2=bicicleta, 3=camió"));
